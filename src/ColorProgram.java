...
public class ColorProgram {
    public static void main(String[] args) {
        ...
        Color aColor = new Color("a color", 10, 14, 16);
        colors.add(aColor);
...
//        System.out.println(green.convertToHex());


        for(Color c : colors){
            System.out.println(c.getName() + ": " + c.convertToHex());
        }
//
//        for(Color c : colors){
//            System.out.println(c);
...
//        System.out.println(aColor.convertToHex());
    }
}
